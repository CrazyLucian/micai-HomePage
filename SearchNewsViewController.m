...
#import "NewsListPicTableViewCell.h"
#import "NewsListTableViewCell.h"
#import "NewsViewModel.h"
@interface SearchNewsViewController ()<UITextFieldDelegate>
@property (weak, nonatomic) IBOutlet UITextField *txtSearch;
@property (weak, nonatomic) IBOutlet UITableView *itemTableView;
@property (weak, nonatomic) IBOutlet UIView *noDataView;
@property (nonatomic, retain) NewsViewModel *viewModel;
...
- (void)viewDidLoad {
    ...
    [self.itemTableView registerNib:[UINib nibWithNibName:@"NewsListPicTableViewCell" bundle:nil] forCellReuseIdentifier:@"NewsListPicTableViewCell"];
    [self.itemTableView registerNib:[UINib nibWithNibName:@"NewsListTableViewCell" bundle:nil] forCellReuseIdentifier:@"NewsListTableViewCell"];
...
-(void)footerRefreshing{
    ...
    if (self.txtSearch.text.length != 0) {
        [self.viewModel searchNewsWithKeywords:self.txtSearch.text page:@(self.pageIndex)];
    }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (model.thumb.count == 1) {
        NewsListPicTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"NewsListPicTableViewCell"];
        [cell initCellWithModel:model isHidden:0];
        return cell;
    }
